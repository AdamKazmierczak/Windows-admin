...
if ($InstallDocker) {
 ...
 - 'docker run -d --privileged --restart=unless-stopped --net=host -v /etc/kubernetes:/etc/kubernetes -v /var/run:/var/run rancher/rancher-agent:v2.2.4 --server https://172.21.51.75 --token 4j7nqb2xrcqk2cbs4grhg548jmdzf9vhxhsqng87zsr5s4tgbd7kdv --ca-checksum fb930272a344e22ccaa299750187988e1620ad5c457d232610ef96ba0ed17a11 --etcd --controlplane --worker'
 - 'curl -s https://packages.cloud.google.com/apt/doc/apt-key.gpg | apt-key add - && -'
 - 'echo "deb http://apt.kubernetes.io/ kubernetes-xenial main" | tee /etc/apt/sources.list.d/kubernetes.list && -'
 - ' apt-get update -q && -'
 - ' apt-get install -qy kubelet=1.13.5-00 kubectl=1.13.5-00 kubeadm=1.13.5-00'
 - 'apt-get install software-properties-common'
 - 'apt-get install realmd krb5-user software-properties-common packagekit'
